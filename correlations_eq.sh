...
do
	...
	difmap -cw $fw_corr $maps_path'src_'$fw'_smooth_masked_map_eq.fits' $maps_path'smica_release3_'$fw'_smooth_masked_map_eq.fits' -o $project_home_path'correlations_results/corr_'$fw'_'$fw_corr'_eq.fits'
	...
	#masking
	mapcut $project_home_path'correlations_results/corr_'$fw'_'$fw_corr'_eq.fits' -rm -90.0d,0d,-5.0d,360.0d -o temp.fits
	mapcut temp.fits -rm 90.0d,0.0d,20.0d -o $project_home_path'correlations_results/corr_'$fw'_'$fw_corr'_masked_eq.fits'
...
do
	...
	do
		...
		difmap -cw $fw_corr $maps_path'src_'$fw'_smooth_masked_map_eq.fits' $maps_path'lcdm_map_'$fw'_smooth_masked_map_eq_'$random'.fits' -o $project_home_path'correlations_results/corr_lcdm_'$fw'_'$fw_corr'_'$random'_eq.fits'
		...
		#mask-3
		mapcut $project_home_path'correlations_results/corr_lcdm_'$fw'_'$fw_corr'_'$random'_eq.fits' -rm -90.0d,0d,-5.0d,360.0d -o temp.fits
		mapcut temp.fits -rm 90.0d,0.0d,20.0d -o $project_home_path'correlations_results/corr_lcdm_'$fw'_'$fw_corr'_'$random'_masked_eq.fits'
